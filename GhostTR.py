...
def option():
    ...
    stderr.writelines(f"""
     ...
     \____    /____  __ __  ______       \__    ___/___________    ____ |  | __
     /     // __ \|  |  \/  ___/  ______ |    |  \_  __ \__  \ _/ ___\|  |/ /
    /     /\  ___/|  |  /\___ \  /_____/ |    |   |  | \// __ \\  \___|    < 
   /_______ \___  >____//____  >         |____|   |__|  (____  /\___  >__|_ \
        \/   \/           \/                              \/     \/     \/
              {Wh}[ + ]  C O D E   B Y  Z E U S  [ + ]
    """)
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Zt}ZEUS - TRACKER - IP ADDRESS {Wh}|
       : o    `.        {Wh}|       {Zt}@CODE BY StfuZEUS      {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
